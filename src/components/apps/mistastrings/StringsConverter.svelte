  ...
  <div class="space-y-2">
    <div class="flex items-center justify-between gap-2">
      <div class="flex items-center gap-2">
        ...
        {#if tokens.length > 0}
          <span class="chip preset-outlined text-xs">
      ...
      <div class="card preset-filled-surface-100-900 border border-surface-200-800 overflow-hidden">
        ...
        <div class="flex items-center gap-2 px-3 py-2.5">
          <Collapsible.Trigger class="flex flex-1 cursor-pointer items-center gap-2 text-left">
            ...
            <span class="chip preset-tonal-surface text-xs">{history.length}</span>
              ...
              <div class="flex items-center gap-3 px-3 py-2.5">
                <div class="min-w-0 flex-1 space-y-1">
                  ...
                  <div class="flex items-center gap-1.5">
                    <span class="chip preset-tonal-surface text-xs">{entry.operatorLabel}</span>
                    <span class="chip preset-outlined text-xs"
